...
use meeting_bridge::MeetingBridge;
#[cfg(unix)]
...
fn initialize_core_logic(app_handle: &AppHandle) {
    ...
    let meeting_bridge = Arc::new(MeetingBridge::new());
    ...
    app_handle.manage(meeting_bridge.clone());
...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        commands::meeting::enable_meeting_bridge,
        commands::meeting::disable_meeting_bridge,
        commands::meeting::is_meeting_bridge_enabled,
